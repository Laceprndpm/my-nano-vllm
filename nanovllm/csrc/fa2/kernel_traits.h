...
#endif
    using Element2 =
        std::conditional_t<std::is_same_v<Element, cutlass::half_t>, __half2, __nv_bfloat162>;
...
struct Flash_fwd_kernel_traits : public Base {
    ...
    using SmemLayoutQ =
        decltype(tile_to_shape(SmemLayoutAtomQ{}, Shape<Int<kBlockM>, Int<kHeadDim>>{}));

    using SmemLayoutKV =
        decltype(tile_to_shape(SmemLayoutAtomQ{}, Shape<Int<kBlockN>, Int<kHeadDim>>{}));
    ...
    using SmemLayoutO =
        decltype(tile_to_shape(SmemLayoutAtomO{}, Shape<Int<kBlockM>, Int<kHeadDim>>{}));
    ...
    using Gmem_copy_struct = std::conditional_t<Has_cp_async,
                                                SM80_CP_ASYNC_CACHEGLOBAL<cute::uint128_t>,
                                                AutoVectorizingCopyWithAssumedAlignment<128>>;
    using GmemTiledCopyQKV = decltype(make_tiled_copy(
        Copy_Atom<Gmem_copy_struct, Element>{}, GmemLayoutAtom{}, Layout<Shape<_1, _8>>{}));
    ...
    using GmemLayoutAtomP =
        Layout<Shape<Int<kNThreads / kGmemThreadsPerRowP>, Int<kGmemThreadsPerRowP>>,
               Stride<Int<kGmemThreadsPerRowP>, _1>>;

    using GmemTiledCopyP =
        decltype(make_tiled_copy(Copy_Atom<AutoVectorizingCopyWithAssumedAlignment<128>, Element>{},
                                 GmemLayoutAtomP{},
                                 Layout<Shape<_1, _8>>{}));

    using GmemLayoutAtomOaccum = std::conditional_t<kBlockKSmem == 32,
    ...
    using GmemTiledCopyRotcossin =
        decltype(make_tiled_copy(Copy_Atom<UniversalCopy<uint64_t>, Element>{},
                                 GmemLayoutAtomRotcossin{},
                                 Layout<Shape<_1, _4>>{}));
    using GmemTiledCopyRotcossinCont =
        decltype(make_tiled_copy(Copy_Atom<AutoVectorizingCopyWithAssumedAlignment<128>, Element>{},
                                 GmemLayoutAtomRotcossin{},
                                 Layout<Shape<_1, _8>>{}));
};
